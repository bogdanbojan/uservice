...
KIND_CLUSTER := bbojan-starter-cluster
...
kind-apply:
	type  zarf\k8s\base\service-pod\base-service.yaml | kubectl apply -f -
...
kind-logs:
	kubectl logs -l app=sales --all-containers=true -f --tail=100 --namespace=service-system
